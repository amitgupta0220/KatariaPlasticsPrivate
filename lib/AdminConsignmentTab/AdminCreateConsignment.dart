...
class AdminCreateConsignment extends StatefulWidget {
  @override
  _AdminCreateConsignmentState createState() => _AdminCreateConsignmentState();
}

class _AdminCreateConsignmentState extends State<AdminCreateConsignment> {
