...
class AdminCompletedConsignment extends StatefulWidget {
  @override
  _AdminCompletedConsignmentState createState() =>
      _AdminCompletedConsignmentState();
}

class _AdminCompletedConsignmentState extends State<AdminCompletedConsignment> {
  @override
                                  ...
                                  builder: (context, snapshot) {
                                    ...
                                    if (snapshot.hasData) {
                                      ...
                                      consignmentData.forEach((consignment) {
                                        ...
                                        consignmentCard
                                            .add(AdminCompletedConsignmentCard(
...
class AdminCompletedConsignmentCard extends StatefulWidget {
  ...
  @override
  _AdminCompletedConsignmentCardState createState() =>
      _AdminCompletedConsignmentCardState();
}

class _AdminCompletedConsignmentCardState
    extends State<AdminCompletedConsignmentCard> {
  @override
  Widget build(BuildContext context) {
    Size size = MediaQuery.of(context).size;
    return Container(
      ...
      child: Row(
        children: [
          Hero(
            tag: "adminCompletedConsignmentCode" + widget.consignmentCode,
            child: Material(
          ...
          Container(
            width: size.width * 0.11,
            child: Hero(
              tag: "adminCompletedConsignmentPickUpLocation" +
                  widget.consignmentCode,
              child: Material(
                color: Colors.transparent,
                child: Text(
          ...
          Container(
            width: size.width * 0.11,
            child: Hero(
              tag: "adminCompletedConsignmentDropLocation" +
                  widget.consignmentCode,
              child: Material(
                color: Colors.transparent,
                child: Text(
            ...
            child: GestureDetector(
              onTap: () {
                Navigator.of(context).push(MaterialPageRoute(
                    builder: (_) => ViewAdminConfirmedConsignment(
...
class ViewAdminConfirmedConsignment extends StatefulWidget {
  final String consignmentCode,
      price,
      pickUpLocation,
      dropLocation,
  ...
  @override
  _ViewAdminConfirmedConsignmentState createState() =>
      _ViewAdminConfirmedConsignmentState();
}

class _ViewAdminConfirmedConsignmentState
    extends State<ViewAdminConfirmedConsignment> {
  @override
  Widget build(BuildContext context) {
    Size size = MediaQuery.of(context).size;
    return Scaffold(
