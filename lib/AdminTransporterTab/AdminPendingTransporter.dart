...
class AdminPendingTransporter extends StatefulWidget {
  @override
  _AdminPendingTransporterState createState() =>
      _AdminPendingTransporterState();
}

class _AdminPendingTransporterState extends State<AdminPendingTransporter> {
  @override
                        ...
                        builder: (context, snapshot) {
                          ...
                          if (snapshot.hasData) {
                            ...
                            userData.forEach((user) {
                              ...
                              transporterWidget.add(AdminPendingTransporterCard(
...
class AdminPendingTransporterCard extends StatefulWidget {
  final String name,
      id,
      email,
      pan,
  ...
  @override
  _AdminPendingTransporterCardState createState() =>
      _AdminPendingTransporterCardState();
}

class _AdminPendingTransporterCardState
    extends State<AdminPendingTransporterCard> {
  @override
  Widget build(BuildContext context) {
    Size size = MediaQuery.of(context).size;
    return Container(
            ...
            child: GestureDetector(
              onTap: () {
                Navigator.of(context).push(MaterialPageRoute(
                    builder: (_) => ViewAdminPendingTransporter(
...
class ViewAdminPendingTransporter extends StatefulWidget {
  final String name,
      email,
      id,
      pan,
  ...
  @override
  _ViewAdminPendingTransporterState createState() =>
      _ViewAdminPendingTransporterState();
}

class _ViewAdminPendingTransporterState
    extends State<ViewAdminPendingTransporter> {
  int currentTab = 0;
