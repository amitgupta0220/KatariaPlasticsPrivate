...
class TabletAdminConfirmedConsignment extends StatefulWidget {
  @override
  _TabletAdminConfirmedConsignmentState createState() =>
      _TabletAdminConfirmedConsignmentState();
}

class _TabletAdminConfirmedConsignmentState
    extends State<TabletAdminConfirmedConsignment> {
  @override
                        ...
                        builder: (context, snapshot) {
                          ...
                          if (snapshot.hasData) {
                            ...
                            consignmentData.forEach((consignment) {
                              ...
                              consignmentCard
                                  .add(AdminConfirmedConsignmentCardTablet(
...
class AdminConfirmedConsignmentCardTablet extends StatefulWidget {
  final String consignmentCode,
      ...
      date,
      truckDetail;
  AdminConfirmedConsignmentCardTablet({
  ...
  @override
  _AdminConfirmedConsignmentCardTabletState createState() =>
      _AdminConfirmedConsignmentCardTabletState();
}

class _AdminConfirmedConsignmentCardTabletState
    extends State<AdminConfirmedConsignmentCardTablet> {
  @override
  Widget build(BuildContext context) {
    Size size = MediaQuery.of(context).size;
    return GestureDetector(
      onTap: () {
        Navigator.of(context).push(MaterialPageRoute(
            builder: (_) => ViewAdminConfirmedConsignmentTablet(
...
class ViewAdminConfirmedConsignmentTablet extends StatefulWidget {
  final String consignmentCode,
      price,
      numberOfTruck,
      pickUpLocation,
      ...
      assignedToName,
      truckDetail;
  ViewAdminConfirmedConsignmentTablet({
    this.consignmentCode,
    this.price,
    this.numberOfTruck,
    this.load,
  ...
  @override
  _ViewAdminConfirmedConsignmentTabletState createState() =>
      _ViewAdminConfirmedConsignmentTabletState();
}

class _ViewAdminConfirmedConsignmentTabletState
    extends State<ViewAdminConfirmedConsignmentTablet> {
  @override
  Widget build(BuildContext context) {
    Size size = MediaQuery.of(context).size;
    return Scaffold(
