...
class TabletAdminMarketingUser extends StatefulWidget {
  @override
  _TabletAdminMarketingUserState createState() =>
      _TabletAdminMarketingUserState();
}

class _TabletAdminMarketingUserState extends State<TabletAdminMarketingUser> {
  @override
                  ...
                  builder: (context, snapshot) {
                    ...
                    if (snapshot.hasData) {
                      ...
                      userData.forEach((user) {
                        ...
                        transporterWidget.add(AdminMarketingDisplayTablet(
...
class AdminMarketingDisplayTablet extends StatelessWidget {
  final String name, email, phone, uid;
  final String createdAt;
  AdminMarketingDisplayTablet(
