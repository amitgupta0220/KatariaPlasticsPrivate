...
class TabletAdminApprovedTransporter extends StatefulWidget {
  @override
  _TabletAdminApprovedTransporterState createState() =>
      _TabletAdminApprovedTransporterState();
}

class _TabletAdminApprovedTransporterState
    extends State<TabletAdminApprovedTransporter> {
  @override
                    ...
                    builder: (context, snapshot) {
                      ...
                      if (snapshot.hasData) {
                        ...
                        userData.forEach((user) {
                          ...
                          transporterWidget
                              .add(AdminApprovedTransporterCardTablet(
                            ...
                            name: name,
                            pan: pan, panUrl: panUrl, regUrl: regUrl,
                            phone: phone,
...
class AdminApprovedTransporterCardTablet extends StatefulWidget {
  final String name,
      email,
      id,
      pan,
  ...
  AdminApprovedTransporterCardTablet(
      {this.createdAt,
      ...
      this.uid});
  @override
  _AdminApprovedTransporterCardTabletState createState() =>
      _AdminApprovedTransporterCardTabletState();
}

class _AdminApprovedTransporterCardTabletState
    extends State<AdminApprovedTransporterCardTablet> {
  @override
  Widget build(BuildContext context) {
    Size size = MediaQuery.of(context).size;
    return GestureDetector(
      onTap: () {
        Navigator.of(context).push(MaterialPageRoute(
            builder: (_) => ViewAdminApprovedTransporterTablet(
...
class ViewAdminApprovedTransporterTablet extends StatefulWidget {
  final String name,
      email,
      id,
      pan,
  ...
  final bool emailVerified, phoneVerified;
  final String createdAt;
  ViewAdminApprovedTransporterTablet({
    this.createdAt,
    this.registrationNumber,
    this.email,
    this.id,
  ...
  @override
  _ViewAdminApprovedTransporterTabletState createState() =>
      _ViewAdminApprovedTransporterTabletState();
}

class _ViewAdminApprovedTransporterTabletState
    extends State<ViewAdminApprovedTransporterTablet> {
  int currentTab = 0;
  var blob;
