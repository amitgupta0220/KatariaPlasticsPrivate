...
class MobileTransporterPersonalDetail extends StatefulWidget {
  final int selectedTab;
  MobileTransporterPersonalDetail({this.selectedTab});
  @override
  _MobileTransporterPersonalDetailState createState() =>
      _MobileTransporterPersonalDetailState();
}

class _MobileTransporterPersonalDetailState
    extends State<MobileTransporterPersonalDetail> {
