...
class TabletTransporterDelivered extends StatefulWidget {
  @override
  _TabletTransporterDeliveredState createState() =>
      _TabletTransporterDeliveredState();
}

class _TabletTransporterDeliveredState
    extends State<TabletTransporterDelivered> {
  @override
                      ...
                      builder: (context, snapshot) {
                        ...
                        if (snapshot.hasData) {
                          ...
                          userData.forEach((consignment) {
                            ...
                            bidWidget.add(TransporterDeliveredCardTablet(
...
class TransporterDeliveredCardTablet extends StatefulWidget {
  final bidPrice, dropLocation, pickUpLocation, date, consignmentCode;
  TransporterDeliveredCardTablet(
      {this.bidPrice,
      ...
      this.pickUpLocation});
  @override
  _TransporterDeliveredCardTabletState createState() =>
      _TransporterDeliveredCardTabletState();
}

class _TransporterDeliveredCardTabletState
    extends State<TransporterDeliveredCardTablet> {
  @override
  Widget build(BuildContext context) {
    Size size = MediaQuery.of(context).size;
    return Container(
      ...
      child: Row(
        children: [
          Container(
            height: size.height * 0.35,
            width: (size.width - size.width * 0.3) / 3,
            decoration: BoxDecoration(
