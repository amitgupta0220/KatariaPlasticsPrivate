...
class TransporterCardWidget extends StatefulWidget {
  ...
  TransporterCardWidget(
      ...
      this.description});
  @override
  _TransporterCardWidgetState createState() => _TransporterCardWidgetState();
}

class _TransporterCardWidgetState extends State<TransporterCardWidget> {
  String code, load, truckDetail, drop, pickUp, description, price;
  // final GlobalKey<ScaffoldState> _scaffoldKey = new GlobalKey<ScaffoldState>();
  final _bidController = TextEditingController();
  String email, myBidPrice = "", id, currentMinBid, username;
