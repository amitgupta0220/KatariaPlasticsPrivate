...
class TabletTransporterOngoing extends StatefulWidget {
  ...
  TabletTransporterOngoing(
      ...
      this.description});
  @override
  _TabletTransporterOngoingState createState() =>
      _TabletTransporterOngoingState();
}

class _TabletTransporterOngoingState extends State<TabletTransporterOngoing> {
