...
class TransporterOngoingCard extends StatefulWidget {
  ...
  TransporterOngoingCard(
      ...
      this.description});
  @override
  _TransporterOngoingCardState createState() => _TransporterOngoingCardState();
}

class _TransporterOngoingCardState extends State<TransporterOngoingCard> {
