...
class MobileAdminPendingTransporter extends StatefulWidget {
  @override
  _MobileAdminPendingTransporterState createState() =>
      _MobileAdminPendingTransporterState();
}

class _MobileAdminPendingTransporterState
    extends State<MobileAdminPendingTransporter> {
  @override
                    ...
                    builder: (context, snapshot) {
                      ...
                      if (snapshot.hasData) {
                        ...
                        userData.forEach((user) {
                          ...
                          transporterWidget
                              .add(AdminPendingTransporterCardMobile(
                            ...
                            name: name,
                            pan: pan, regUrl: regUrl, panUrl: panUrl,
                            phone: phone,
...
class AdminPendingTransporterCardMobile extends StatefulWidget {
  final String name,
      id,
      email,
      pan,
  ...
  AdminPendingTransporterCardMobile({
    this.createdAt,
    this.id,
  ...
  @override
  _AdminPendingTransporterCardMobileState createState() =>
      _AdminPendingTransporterCardMobileState();
}

class _AdminPendingTransporterCardMobileState
    extends State<AdminPendingTransporterCardMobile> {
  @override
  Widget build(BuildContext context) {
    Size size = MediaQuery.of(context).size;
    return GestureDetector(
      onTap: () {
        Navigator.of(context).push(MaterialPageRoute(
            builder: (_) => ViewAdminPendingTransporterMobile(
...
class ViewAdminPendingTransporterMobile extends StatefulWidget {
  final String name,
      email,
      id,
      pan,
  ...
  final bool emailVerified, phoneVerified;
  final String createdAt;
  ViewAdminPendingTransporterMobile({
    this.createdAt,
    this.registrationNumber,
    this.id,
    this.email,
  ...
  @override
  _ViewAdminPendingTransporterMobileState createState() =>
      _ViewAdminPendingTransporterMobileState();
}

class _ViewAdminPendingTransporterMobileState
    extends State<ViewAdminPendingTransporterMobile> {
  int currentTab = 0;
  var blob;
