...
class MobileAdminApprovedTransporter extends StatefulWidget {
  @override
  _MobileAdminApprovedTransporterState createState() =>
      _MobileAdminApprovedTransporterState();
}

class _MobileAdminApprovedTransporterState
    extends State<MobileAdminApprovedTransporter> {
  @override
                    ...
                    builder: (context, snapshot) {
                      ...
                      if (snapshot.hasData) {
                        ...
                        userData.forEach((user) {
                          ...
                          transporterWidget
                              .add(AdminApprovedTransporterCardMobile(
                            //TODO: sort by date to add
                            createdAt: createdAt.toDate().toString(),
                            email: email,
                            id: id, regUrl: regUrl, panUrl: panUrl,
...
class AdminApprovedTransporterCardMobile extends StatefulWidget {
  final String name,
      email,
      id,
      pan,
  ...
  AdminApprovedTransporterCardMobile(
      {this.createdAt,
      ...
      this.uid});
  @override
  _AdminApprovedTransporterCardMobileState createState() =>
      _AdminApprovedTransporterCardMobileState();
}

class _AdminApprovedTransporterCardMobileState
    extends State<AdminApprovedTransporterCardMobile> {
  @override
  Widget build(BuildContext context) {
    Size size = MediaQuery.of(context).size;
    return GestureDetector(
      onTap: () {
        Navigator.of(context).push(MaterialPageRoute(
            builder: (_) => ViewAdminApprovedTransporterMobile(
...
class ViewAdminApprovedTransporterMobile extends StatefulWidget {
  final String name,
      email,
      id,
      pan,
  ...
  final bool emailVerified, phoneVerified;
  final String createdAt;
  ViewAdminApprovedTransporterMobile({
    this.createdAt,
    this.registrationNumber,
    this.email,
    this.id,
  ...
  @override
  _ViewAdminApprovedTransporterMobileState createState() =>
      _ViewAdminApprovedTransporterMobileState();
}

class _ViewAdminApprovedTransporterMobileState
    extends State<ViewAdminApprovedTransporterMobile> {
  int currentTab = 0;
  var blob;
