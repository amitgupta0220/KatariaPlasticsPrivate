...
class MobileAdminOpenConsignment extends StatefulWidget {
  @override
  _MobileAdminOpenConsignmentState createState() =>
      _MobileAdminOpenConsignmentState();
}

class _MobileAdminOpenConsignmentState
    extends State<MobileAdminOpenConsignment> {
  @override
                        ...
                        builder: (context, snapshot) {
                          ...
                          if (snapshot.hasData) {
                            ...
                            consignmentData.forEach((consignment) {
                              ...
                              consignmentCard
                                  .add(AdminOpenConsignmentCardMobile(
...
class AdminOpenConsignmentCardMobile extends StatefulWidget {
  final String consignmentCode,
      ...
      currentMinBid,
      truckDetail;
  AdminOpenConsignmentCardMobile({
  ...
  @override
  _AdminOpenConsignmentCardMobileState createState() =>
      _AdminOpenConsignmentCardMobileState();
}

class _AdminOpenConsignmentCardMobileState
    extends State<AdminOpenConsignmentCardMobile> {
  @override
  Widget build(BuildContext context) {
    Size size = MediaQuery.of(context).size;
    return GestureDetector(
      onTap: () {
        Navigator.of(context).push(MaterialPageRoute(
            builder: (_) => ViewAdminOpenConsignmentMobile(
...
class ViewAdminOpenConsignmentMobile extends StatefulWidget {
  final String consignmentCode,
      price,
      pickUpLocation,
      dropLocation,
      ...
      currentMinBid,
      truckDetail;
  ViewAdminOpenConsignmentMobile({
    this.consignmentCode,
    this.price,
    this.load,
    this.truckDetail,
  ...
  @override
  _ViewAdminOpenConsignmentMobileState createState() =>
      _ViewAdminOpenConsignmentMobileState();
}

class _ViewAdminOpenConsignmentMobileState
    extends State<ViewAdminOpenConsignmentMobile> {
  int currentTab = 0;
  @override
  Widget build(BuildContext context) {
    Size size = MediaQuery.of(context).size;
                ...
                builder: (context, snapshot) {
                  ...
                  if (snapshot.hasData) {
                    ...
                    userData.forEach((bid) {
                      ...
                      var id = bid.data()["id"];
                      bidWidget.add(DisplayBidAdminOpenConsignmentMobile(
                        consignmentCode: widget.consignmentCode,
                        username: username,
                        id: id,
                        bidPrice: bidPrice,
...
class DisplayBidAdminOpenConsignmentMobile extends StatefulWidget {
  final String consignmentCode, bidPrice, currentMinBidBy, username, id;
  DisplayBidAdminOpenConsignmentMobile({
    this.bidPrice,
    this.consignmentCode,
  ...
  @override
  _DisplayBidAdminOpenConsignmentMobileState createState() =>
      _DisplayBidAdminOpenConsignmentMobileState();
}

class _DisplayBidAdminOpenConsignmentMobileState
    extends State<DisplayBidAdminOpenConsignmentMobile> {
  @override
  Widget build(BuildContext context) {
    Size size = MediaQuery.of(context).size;
    return Padding(
