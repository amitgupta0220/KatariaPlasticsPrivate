...
class MobileTransporterDeliveredOld extends StatefulWidget {
  @override
  _MobileTransporterDeliveredOldState createState() =>
      _MobileTransporterDeliveredOldState();
}

class _MobileTransporterDeliveredOldState
    extends State<MobileTransporterDeliveredOld> {
  @override
          ...
          GestureDetector(
            onTap: () {
              Navigator.of(context).push(MaterialPageRoute(
                  builder: (_) => ViewTransporterDeliveredMobile(
...
class ViewTransporterDeliveredMobile extends StatefulWidget {
  final String code;
  ViewTransporterDeliveredMobile({this.code});
  @override
  _ViewTransporterDeliveredMobileState createState() =>
      _ViewTransporterDeliveredMobileState();
}

class _ViewTransporterDeliveredMobileState
    extends State<ViewTransporterDeliveredMobile> {
  int currentTab = 0;
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    ...
                    textAlign: TextAlign.left,
                    style: TextStyle(color: Color(0xff4d4d4d), fontSize: 11),
                  ),
                  SizedBox(
                    height: size.height * 0.02,
                  ),
