...
class MobileAdminDeliveredConsignment extends StatefulWidget {
  @override
  _MobileAdminDeliveredConsignmentState createState() =>
      _MobileAdminDeliveredConsignmentState();
}

class _MobileAdminDeliveredConsignmentState
    extends State<MobileAdminDeliveredConsignment> {
  @override
                        ...
                        builder: (context, snapshot) {
                          ...
                          if (snapshot.hasData) {
                            ...
                            consignmentData.forEach((consignment) {
                              ...
                              consignmentCard
                                  .add(AdminDeliveredConsignmentCardMobile(
...
class AdminDeliveredConsignmentCardMobile extends StatefulWidget {
  final String consignmentCode,
      ...
      date,
      truckDetail;
  AdminDeliveredConsignmentCardMobile({
  ...
  @override
  _AdminDeliveredConsignmentCardMobileState createState() =>
      _AdminDeliveredConsignmentCardMobileState();
}

class _AdminDeliveredConsignmentCardMobileState
    extends State<AdminDeliveredConsignmentCardMobile> {
  @override
  Widget build(BuildContext context) {
    Size size = MediaQuery.of(context).size;
    return GestureDetector(
      onTap: () {
        Navigator.of(context).push(MaterialPageRoute(
            builder: (_) => ViewAdminDeliveredConsignmentMobile(
...
class ViewAdminDeliveredConsignmentMobile extends StatefulWidget {
  final String consignmentCode,
      price,
      pickUpLocation,
      dropLocation,
      ...
      assignedToName,
      truckDetail;
  ViewAdminDeliveredConsignmentMobile({
    this.consignmentCode,
    this.price,
    this.load,
    this.truckDetail,
  ...
  @override
  _ViewAdminDeliveredConsignmentMobileState createState() =>
      _ViewAdminDeliveredConsignmentMobileState();
}

class _ViewAdminDeliveredConsignmentMobileState
    extends State<ViewAdminDeliveredConsignmentMobile> {
  @override
  Widget build(BuildContext context) {
    Size size = MediaQuery.of(context).size;
    return Scaffold(
